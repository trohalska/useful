...
{	
	...
	// 	for (int i = 0; i < 2; ++i)
	// 	{
	// 		test[i] = (char *)malloc(2 * sizeof(char));
	// 	}
	// 	mx_del_strarr(&test);
	...
	if(mx_count_substr("he  l  o", "lo") == -1) {
		printf("%s\n", "\x1b[33mFILED FOR INPUTS: \"he  l  o\", lo\033[0m");
	}
	else {
	...
	// char dst_test4[] = "  ";
	// char src_test4[] = "123 456";

	// printf("%s", mx_memccpy(dst_test4, src_test4, 52, 2));
	
	// if(mx_strcmp("12", mx_memccpy(dst_test4, src_test4, 52, 2)) == 0) {
	// 	printf("%s\n", "\x1b[32mOK FOR INPUTS:  \"123 456\", \"  \", 52, 2\033[0m");
	// }
	// else {
	// 	printf("%s\n", "\x1b[31mFILED FOR INPUTS:  \"123 456\", \"  \", 52, 2\033[0m");
	// }
	// printf("%c", '\n');
	// sleep(1);
	//
